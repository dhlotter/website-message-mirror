...
const features = [
  ...
  {
    id: 2,
    icon: <ShieldIcon className="w-12 h-12 text-blue-500" />,
    title: 'Secure Backup',
    description:
  ...
  {
    id: 3,
    icon: <SyncIcon className="w-12 h-12 text-blue-500" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => (
            ...
            >
              <div className="mb-5 p-4 bg-blue-500 bg-opacity-10 rounded-xl inline-block group-hover:bg-opacity-20 transition-all">
                {feature.icon}
              </div>
